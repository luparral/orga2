...
A continuación, shifteamos 1 píxel a derecha para subsanar lo recientemente explicado y tener los 3 píxeles que utilizaremos en la parte menos significativa de los xmm.
...
Así mismo, la implementación más performante resultó ser ASM2. Esto también era esperado, ya que, procesó mas de 1 pixel por iteración, y, en definitiva, realizó menos accesos a memoria.\\
